  ...
  <CommonPage>
    ...
    <MeModal ref="modalRef" width="520px">
      ...
      >
        ...
        >
          <n-input v-model:value="modalForm.paramTitle"  />
        </n-form-item>
        ...
        >
          <n-input v-model:value="modalForm.paramDesc"  />
        </n-form-item>
        ...
        >
          <n-select
            v-model:value="modalForm.paramType"
            :options="paramType"
            label-field="label"
            value-field="value"
            clearable
        ...
        >
          <n-select
            v-model:value="modalForm.paramGroup"
            :options="paramGroup"
            label-field="label"
            value-field="value"
            clearable
